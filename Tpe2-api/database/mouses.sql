...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-10-2021 a las 19:33:20
...
--
CREATE DATABASE IF NOT EXISTS `db_mouses` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `db_mouses`;
...
('root', '[{\"db\":\"db_mouses\",\"table\":\"marcas\"},{\"db\":\"db_mouses\",\"table\":\"mouses\"},{\"db\":\"db_mouses\",\"table\":\"usuario\"},{\"db\":\"mouses\",\"table\":\"marcas\"},{\"db\":\"mouses\",\"table\":\"usuario\"},{\"db\":\"mouses\",\"table\":\"mouses\"}]');
...
('root', '2021-10-15 17:32:05', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
